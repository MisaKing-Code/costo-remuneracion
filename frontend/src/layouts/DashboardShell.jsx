export default function DashboardShell({ sidebar, children }) {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden text-stone-100 md:px-5 md:py-3 lg:px-6">
      <div className="mx-auto grid w-full max-w-[1600px] gap-4 lg:grid-cols-[324px_minmax(0,1fr)]">
        {sidebar ? <div className="max-md:hidden md:block lg:sticky lg:top-4 lg:h-[calc(100vh-2rem)]">{sidebar}</div> : null}
